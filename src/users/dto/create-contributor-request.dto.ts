...
export class CreateContributorRequestDto {
  @ApiProperty({
    ...
    example: 'Je suis passionné par les langues africaines et je souhaite contribuer à la préservation du patrimoine linguistique...',
    minLength: 50,
    maxLength: 1000
  })
  @IsString()
  ...
  @ApiPropertyOptional({
    ...
    example: 'Diplômé en linguistique, 5 ans d\'enseignement du français, traducteur freelance...',
    maxLength: 500
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    ...
    example: 'Français (natif), Anglais (courant), Wolof (intermédiaire), Arabe (débutant)',
    maxLength: 200
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description: 'Engagement du candidat à respecter les règles de la communauté',
    example: true
  })
  @IsBoolean()
  commitment: boolean;
