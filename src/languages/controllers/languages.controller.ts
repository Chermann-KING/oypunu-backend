...
export class LanguagesController {
  ...
  @Get('popular')
  @ApiOperation({ summary: 'Récupérer les langues populaires (avec le plus de mots)' })
  @ApiResponse({
    status: 200,
  ...
  async getPopularLanguages(@Query('limit') limit?: string): Promise<Language[]> {
  ...
  @ApiResponse({ status: 403, description: 'Permissions insuffisantes (contributeur requis)' })
  async proposeLanguage(
    ...
    try {
      ...
      const result = await this.languagesService.proposeLanguage(createLanguageDto, req.user);
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Récupérer les langues en attente d\'approbation (admin)' })
  @ApiResponse({
    status: 200,
  ...
  async getPendingLanguages(@Request() req: RequestWithUser): Promise<Language[]> {
  ...
  @ApiResponse({ status: 400, description: 'Langue non éligible à l\'approbation' })
  @ApiResponse({ status: 403, description: 'Permissions insuffisantes' })
  @ApiResponse({ status: 404, description: 'Langue non trouvée' })
  ...
  @Roles('superadmin')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Migrer les mots vers les IDs de langue (superadmin)' })
  @ApiResponse({
    status: 200,
  ...
  @Roles('superadmin')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Migrer les utilisateurs vers les IDs de langue (superadmin)' })
  @ApiResponse({
    status: 200,
  ...
  @Roles('superadmin')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Mettre à jour les statistiques des langues (superadmin)' })
  @ApiResponse({
    status: 200,
  ...
  @Roles('superadmin')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Nettoyer les anciens champs de langue (superadmin)' })
  @ApiResponse({
    status: 200,
